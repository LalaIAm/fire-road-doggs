  ...
  return (
    <section className="py-32 px-6 border-t border-ink/10 relative">
      <div className="max-w-4xl mx-auto">
        <h2 className="font-serif text-5xl md:text-7xl mb-12 relative inline-block">
          The Anti-Grid <br />
        ...
        <div className="grid md:grid-cols-2 gap-12 font-mono text-sm leading-loose">
          <div>
            ...
            <p className="mb-6">01. MOST APPS ARE ROBOTS.</p>
          ...
          <div>
            <p className="mb-6">02. THE PACK IS REAL.</p>
            <p className="text-gray-600">
